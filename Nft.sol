    ...
    contract KodSatiriNft is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 3000000000000000; 
      ...
      constructor() ERC721("KodSatiriNft", "KSN") {}
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmSz7xf9613fCPJqNEfFuSnrNQr2QXsHCSaPaMeFfFSSs8x/hidden.json";
        }
